...
return new class extends Migration
{
    ...
    {
        // Get the current view definition to preserve existing fields
        DB::statement(
            <<<SQL
...
-- Ausstoß pro Stunde [kg/h] = Extrusionsgeschwindigkeit * Profilgewicht_oben * 60 / 1000
    oc.calculation_working_extrusion_speed * oc._calculation_working_profile_weight_upperborder * 60 / 1000 AS `output_per_hour`
...
SQL
    ...
    {
        // Recreate the view without the output_per_hour field
        DB::statement(
            <<<SQL
  CREATE OR REPLACE VIEW offers_calculated AS 
  SELECT 
